    ...
    public void run() {
      try {
        ...
        while (true) {
          ...
          InterestData interestData = (InterestData) inputFromClient.readObject();

          double years = interestData.getYears();
          double interest = interestData.getInterest();
          double loan = interestData.getLoan();
